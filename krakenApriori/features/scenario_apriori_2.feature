Feature: Scenario 2
  ...
  Scenario: admin create a new page and list pages
    ...
    And Admin create a New Page with title "<title>" and description "<description>"
    And I wait for 1 seconds
    And Admin publishes page when total is <total>
    And Admin navigates to "/pages" page and expected total <total>
    And I wait for 2 seconds
    Then Admin sees <total> pages with title "<title>"
