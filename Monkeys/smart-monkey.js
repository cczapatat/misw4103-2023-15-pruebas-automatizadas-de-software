...
var evtIndex = 1
var focused = false
const username = "je.munozr1@uniandes.edu.co";
const password = "gomito2023"
...
function randHover(){
    ...
    cy.window().then((win)=>{
        ...
        cy.task("logCommand", { funtype: "Selector focus (hover)", info: info},{timeout: 80000})
        focused = !!win.document.activeElement
    })
}
...
function reload(){
    cy.reload()
    focused = false
    cy.task("logCommand", { funtype: "Page navigation (Reload)", info: "Successfully reloaded the page"},{timeout: 80000})
}
